...
*/
$config['tables']['users']           = 'prj_user_aims';
$config['tables']['groups']          = 'prj_user_groups_aims';
$config['tables']['users_groups']    = 'prj_user_group_reference_aims';
$config['tables']['login_attempts']  = 'prj_login_attempts_aims';
 ...
 */
$config['site_title']                 = "Alumni Information & Management System";       // Site Title, example.com
$config['admin_email']                = "admin@gmail.com"; // Admin Email, admin@example.com
$config['default_group']              = 'alumni';           // Default group, use name
