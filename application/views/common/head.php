...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo base_url(); ?>img/newlogo.jpg">

    <title>Optimind HRIS  | <?php echo $title; ?></title>
   ...
   <!--  <link href="<?php echo base_url(); ?>assets/css/font-awesome.min.css" rel="stylesheet"> -->
    ...
    <link href="<?php echo base_url(); ?>assets/css/table-responsive.css" rel="stylesheet" />
      ...
      <link rel="stylesheet" type="text/css" href="assets/css/bootstrap-fileupload/bootstrap-fileupload.css" />
    <link rel="stylesheet" type="text/css" href="assets/css/bootstrap-wysihtml5/bootstrap-wysihtml5.css" />
