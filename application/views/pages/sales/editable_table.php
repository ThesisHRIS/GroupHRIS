                  ...
                  <div class="panel-body">
                      <div class="adv-table editable-table ">
                          ...
                          <table class="table table-striped table-hover table-bordered" id="editable-sample">
                              ...
                              <tbody>
                                 <?php $count=0;$total=23; foreach ($fetchCollection as $listC) {$total++;}
                          foreach ($fetchCollection as $listC) { 
                          if($count==1){
                            break;
                          }
                          ?>
                           ...
                           <tr>
                              ...
                              <td>Invoice_Copy:<a href ="<?php echo "uploads/".$listC['folder_name']."/".$listC['filename']?>"><?php echo $listC['filename']; ?></a><br>
